    ...
    <div id='contact-link' className={show ? "contact-container show-up-animation" : "contact-container"}>
      ...
      {show &&
        <div className="contact-container-1 contact-box">
          ...
          <div className="contact-button" onClick={() => {
              document.querySelector(`.contact-button`).innerHTML = `This button does nothing 🐸. Ping me on <a className="contact-button-clicked" target="_blank" href='https://www.linkedin.com/in/ansaf-nisam'>linkedin</a>`
            }}
          >Say Hello!</div>
        </div>
      }
